...
let correct5thcode = secretCode.charCodeAt(4) >= 65 && secretCode.charCodeAt(4) <= 90
let correct10thcode = secretCode.charCodeAt(9) >= 48 && secretCode.charCodeAt(9) <= 57
let is15char= secretCode.length == 15
let codeIsValid = correct5thcode && correct10thcode && is15char
